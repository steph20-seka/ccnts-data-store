...
export function Footer() {
  ...
  // Services links
  const servicesLinks = [
    t('footer.services.cartography'),
    t('footer.services.gis'),
    t('footer.services.remote'),
    t('footer.services.modeling'),
    t('footer.services.dataScience'),
  ];
    ...
    <footer className="bg-gradient-to-br from-slate-950 via-blue-950 to-slate-900 text-white border-t border-white/10">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 sm:py-16 lg:py-20">
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-10 sm:gap-12">
          ...
          {/* Quick Links */}
          <div>
            <h3 className="text-white mb-5 sm:mb-6 text-lg sm:text-xl font-bold">{t('footer.quickLinks')}</h3>
          ...
          {/* Services */}
          <div>
            <h3 className="text-white mb-5 sm:mb-6 text-lg sm:text-xl font-bold">{t('footer.ourExpertise')}</h3>
          ...
          {/* Contact Info */}
          <div>
            <h3 className="text-white mb-5 sm:mb-6 text-lg sm:text-xl font-bold">{t('footer.contactTitle')}</h3>
        ...
        <div className="border-t border-white/20 mt-12 sm:mt-16 pt-8 sm:pt-10">
          <div className="flex flex-col md:flex-row justify-between items-center gap-4 text-sm sm:text-base">
            <p className="text-gray-200 text-center md:text-left font-medium">
              &copy; {currentYear} CCNTS. {t('footer.copyright')}
            </p>
